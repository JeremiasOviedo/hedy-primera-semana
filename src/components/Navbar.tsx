    ...
    <div className="flex justify-between items-center px-2 w-full h-20  text-white bg-gradient-to-r from-violet-400  to-violet-500 fixed">
      ...
      <div>
        <ul className="hidden md:flex h-full items-center">
          <li className="nav-links px-4 cursor-pointer capitalize font-medium text-gray-100 hover:scale-105 hover:text-white duration-200 link-underline text-left">
            <Link to="/">Home</Link>
          </li>
          <li className="nav-links px-4 cursor-pointer capitalize font-medium text-gray-100 hover:scale-105 hover:text-white duration-200 link-underline text-left">
      ...
      <ul className="hidden md:flex h-full items-center"></ul>
      ...
      {nav && (
        <ul className="flex flex-col mt-[80px] justify-top items-left absolute top-0 left-0 w-full h-[400px] bg-gradient-to-r from-violet-400 to-violet-500">
          <li className="mx-4 cursor-pointer capitalize py-6 text-xl text-gray-100 hover:text-white duration-200 link-underline text-left">
            <Link to="/">Home</Link>
          </li>
          <li className="mx-4 cursor-pointer capitalize py-6 text-xl text-gray-100 hover:text-white duration-200 link-underline text-left">
          <Link to="/events">Eventos</Link>
